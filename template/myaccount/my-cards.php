	...
	<div id="storingStepUser" class="box">
        ...
        <div class="payment_module paytpv_iframe" id="nueva_tarjeta" style="display:none">
            <?php if ($isJetIframeActive == 0 ) :?>
                <iframe id="ifr-paytpv-container-acount" src="<?php print $url_paytpv?>" name="paytpv" style="min-width: 300px; border-top-width: 0px; border-right-width: 0px; border-bottom-width: 0px; border-left-width: 0px; border-style: initial; border-color: initial; border-image: initial; height: 360px; " marginheight="0" marginwidth="0" scrolling="no"></iframe>
            <?php else : ?>
