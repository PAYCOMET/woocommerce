        ...
        <div class="col-sm-8">
            <div class="form-group">
                ...
                <div class="form-inline">
                    ...
                    <select class="form-control" style="height:30px; width: 142px; border: 1px solid #dcd7ca; font-size: 18px; padding: 0 0 0 10px;" data-paycomet="dateMonth">
                    ...
                    <select class="form-control" style="height:30px; width: 142px; border: 1px solid #dcd7ca; font-size: 18px; padding: 0 0 0 10px;" data-paycomet="dateYear">
