...
class Paycomet_Webmoney extends Paycomet_APM
{
    ...
    public function __construct()
    {
        ...
        $this->icon = PAYTPV_PLUGIN_URL . 'images/apms/webmoney.svg';
        ...
        $this->description = __('You will be redirected to WebMoney', 'wc_paytpv' );
        ...
        if ($this->title == "Paga con WebMoney") {
            $this->title = __( 'Pay with WebMoney', 'wc_paytpv' );
        }
        if ($this->description == "Se te redirigirá a WebMoney") {
            $this->description = __( 'You will be redirected to WebMoney', 'wc_paytpv' );
        }
