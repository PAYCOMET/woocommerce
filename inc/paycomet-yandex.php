...
class Paycomet_Yandex extends Paycomet_APM
{
    // Setup our Gateway's id, description and other values
    public function __construct()
    {
        $this->id = 'paycomet_yandex';
        $this->icon = PAYTPV_PLUGIN_URL . 'images/apms/yandex.svg';
        ...
        $this->description = __('You will be redirected to Yandex Money', 'wc_paytpv' );
        ...
        if ($this->title == "Paga con Yandex Money") {
            $this->title = __( 'Pay with Yandex Money', 'wc_paytpv' );
        }
        if ($this->description == "Se te redirigirá a Yandex Money") {
            $this->description = __( 'You will be redirected to Yandex Money', 'wc_paytpv' );
        }
