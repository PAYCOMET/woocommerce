...
final class Paycomet_Block_Support_Bizum extends AbstractPaymentMethodType {

	private $gateway;
	protected $name = 'paycomet_bizum';

	public function initialize() {
		$this->settings = get_option( 'woocommerce_paycomet_bizum_settings', array() );
	}
