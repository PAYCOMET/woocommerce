...
class Paycomet_Qiwi extends Paycomet_APM
{
    ...
    public function __construct()
    {
        ...
        $this->description = __('You will be redirected to QIWI Wallet', 'wc_paytpv' );
        ...
        if ($this->title == "Paga con QIWI Wallet") {
            $this->title = __( 'Pay with QIWI Wallet', 'wc_paytpv' );
        }
        if ($this->description == "Se te redirigirá a QIWI Wallet") {
            $this->description = __( 'You will be redirected to QIWI Wallet', 'wc_paytpv' );
        }
