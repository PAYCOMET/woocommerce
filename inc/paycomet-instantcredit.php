...
function woocommerce_paycomet_instantcredit_enqueue_scripts() {
    ...
    $ic_simulator = 'https://instantcredit.net/simulator/test/ic-simulator.js';
    ...
    function init_form_fields(){
        ...
        $this->form_fields_instantcredit = array(
            ...
            'calculator_position' => array(
                    ...
                    'description' => __( 'Selecto position to show Instant Credit calculator','wc_paytpv'),
                    'desc_tip'    => true,
            ...
            'minCost' => array(
                'title'       => __( 'Min. product price', 'wc_paytpv' ),
                'type'        => 'text',
